...
export function AdminRejectedReservations() {
  ...
  return (
    <div className="min-h-screen bg-[#F6EEED] font-sans py-12 px-4 md:px-8 relative">
      ...
      <div className="max-w-5xl mx-auto pt-10">
        ...
        <h2 className="text-3xl font-bold text-[#2D211F] mb-8 text-center md:text-left">Rejected Reservations</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map(res => (
            <div 
              ...
              className={`bg-white border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow relative cursor-pointer ${selectedIds.includes(res.id) ? 'border-red-500 ring-2 ring-red-500/20' : 'border-gray-200'}`}
            >
              {/* Checkbox */}
              ...
              <div className="flex gap-4 items-center text-sm font-medium text-gray-600 bg-red-50 p-3 rounded-xl border border-red-100">
