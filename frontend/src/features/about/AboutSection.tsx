      ...
      <div className="w-full max-w-[1600px] mx-auto flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 w-full">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="col-span-1 bg-[#E04D2D] rounded-[1.5rem] md:rounded-[2rem] p-4 sm:p-6 md:p-8 flex flex-col justify-between relative overflow-hidden text-white min-h-[150px] sm:min-h-[220px] md:min-h-[240px] lg:h-[340px] xl:h-[380px]"
          >
          ...
          <motion.div
            ...
            className="col-span-1 relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden min-h-[150px] sm:min-h-[220px] md:min-h-[240px] lg:h-[340px] xl:h-[380px] bg-zinc-900 group"
          >
            <img 
