...
export function EventsCtaSection() {
  ...
  return (
    <section className="w-full px-4 md:px-6 pb-12 md:pb-32 pt-8 flex flex-col items-center bg-black">
      <div className="w-full max-w-[1400px] mx-auto">
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-[#E04D2D] rounded-[3rem] p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden group"
        >
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
            ...
            <h3 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6 whitespace-pre-line">
