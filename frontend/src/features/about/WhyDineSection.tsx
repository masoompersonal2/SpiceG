  ...
  return (
    <section ref={containerRef} className="hidden md:block w-full bg-white relative z-10">
      <motion.div 
        ...
        className="w-full px-4 md:px-6 pt-0 pb-16 md:pb-32 flex flex-col items-center bg-black origin-top shadow-2xl"
      >
        <div className="w-full max-w-[1400px] mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-[#0a0a0a] rounded-[2rem] p-6 md:p-12 lg:p-20 border border-gray-800/60 shadow-2xl relative overflow-hidden flex flex-col items-center text-center group"
          >
          ...
          <h2 className="text-xs md:text-sm font-semibold tracking-[0.2em] uppercase text-[#E04D2D] mb-4">
